...
type Modpack(app: Application) as this =
    ...
    member this.CreateMultiMc location manifestFile =
        job {
            ...
            [ "InstanceType=OneSix"
              sprintf "IntendedVersion=%s" manifest.Minecraft.Version
              ...
              "iconKey=default"
              "lastLaunchTime=0"
              sprintf "name=%s %s" manifest.Name manifest.Version
              sprintf "notes=Modpack by %s. Generated by Cursed. Using %s" manifest.Author manifest.Minecraft.ModLoaders.[0].Id
              "totalTimePlayed=0" ]
